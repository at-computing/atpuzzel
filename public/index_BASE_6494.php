...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <form class="form-signin"  method="post" >
      ...
      <div style="display:none" id="wrong" class="alert alert-warning" role="alert">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          je hebt een wachtwoord gevonden 
        </div>
      </div>
    </div>
  </div>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($password)) {
      ...
      while(! feof($fn))  {
        ...
        if  ($password."\n" == $validPassword) {
          echo "<script> $('#prompt').modal('show') </script>" ;
          $succes=TRUE;
          break;
        }
      } 
      ...
      if (!$succes){
          ...
          echo "<script> $('#wrong').show() </script>" ;
      }}
  }
  ?>


  <!-- hier is alvast het eerste van totaal vijf wachtwoorden: Bootstrap_Rulez
  Dit wachtwoord was natuurlijk wel erg makkelijk te vinden. Dus, hup! Zoeken naar die andere vier....
  versie 0.1
  -->
  </body>
</html>
